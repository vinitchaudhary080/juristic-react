...
const services = [
  {
    ...
    desc:
      "100+ arbitrations handled; empaneled with DIAC & multiple corporate panels.",
  },
  {
    id: 2,
    ...
    desc:
      "Delhi Judicial Academy certified (40 hrs); successfully mediated 10+ disputes.",
  },
  {
    id: 3,
    ...
    desc:
      "25+ years Supreme Court practice in civil, criminal & constitutional matters.",
  },
  {
    id: 4,
    ...
    title: "Corporate Law",
    desc:
      "Strategic counsel on commercial, property & personal legal issues.",
  },
  {
    id: 5,
    icon: CivivlIcon,
    title: "Civil",
    desc:
      "Comprehensive agreements: employment, sale, lease, partnership & more.",
  },
  {
    id: 6,
    ...
    title: "Corporation",
    desc:
      "Registration & enforcement for patents, trademarks, copyrights & designs.",
  },
  {
    id: 7,
    icon: CriminalIcon,
    title: "Criminal",
    desc:
      "Company formation, compliance, mergers & acquisitions services.",
  },
  {
    id: 8,
    icon: PILIcon,
    title: "PIL",
    desc:
      "Advisory on SEBI, RBI, FEMA & other statutory regulations.",
  },
];
    ...
    <section id="services" className="bg-white">
      <div className="pt-16 pb-0 container mx-auto px-6 lg:px-8 flex flex-col lg:flex-row justify-between items-center">
        <div className="text-center lg:text-left">
          <h2 className="text-4xl font-semibold text-gray-900">Services</h2>
